export default {
    ...
    modelPlugin: {
        ...
        templates: { openai: "OpenAI 规范", gemini: "Gemini 规范", agnes: "Agnes Image 2.1 Flash", agnesVideo: "Agnes Video V2.0" },
        authoring: {
    ...
    canvas: {
        ...
        nodeTypes: { image: "图片", text: "文本", config: "生成配置", video: "视频", audio: "音频", group: "组", director: "3D 导演台" },
        toolbar: {
            select: "选择", pan: "移动", text: "文本", image: "图片", video: "视频", audio: "音频", config: "生成配置", group: "组", directorDesk: "3D 导演台", extensions: "扩展节点", upload: "上传资产", appearance: "画布外观", clear: "清空画布",
