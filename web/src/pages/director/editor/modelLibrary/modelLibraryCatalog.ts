...
// 本地资源随 web/public/local-assets 一起发布，见 guo-3d-assets 与 mixamo 目录。
export const LOCAL_GUO_ASSETS_AVAILABLE = true;
export const LOCAL_MIXAMO_CHARACTER_AVAILABLE = true;
